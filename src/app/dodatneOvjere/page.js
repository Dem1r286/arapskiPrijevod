...
export default function DodatneOvjerePage() {
  return (
    <div className="flex flex-col items-start justify-center w-screen relative mt-40 px-8 sm:px-20 md:px-50">
      <div className="flex justify-center items-center flex-col mb-20 md:mb-10 self-center text-center">
