...
export default function DodatneOvjerePage() {
  return (
    <div className="flex flex-col items-start justify-center w-screen relative mt-50 px-20 md:px-50">
      <div className="flex justify-center items-center flex-col mb-10 self-center text-center">
        <h1 className="text-5xl font-bold mb-4">
          Uputstvo za dodatne ovjere/legalizaciju dokumenata
        </h1>
        <p className="text-black text-lg max-w-[1000px]">
      ...
      <div className="text-[17px] text-black leading-relaxed space-y-6 max-w-[1200px] mx-auto">
        <p>
