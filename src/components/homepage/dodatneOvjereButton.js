...
export default function DodatneOvjereButton() {
  ...
  return (
    <motion.div
      ref={ref}
      className="flex items-center justify-center flex-col w-full my-50 2xl:my-70 min-w-[350px]"
    ...
    >
      ...
      >
        ...
        <div className="relative border-[#202020] bg-transform transition-transform duration-200 hover:scale-105">
          ...
          >
            <p
              className={`text-sm sm:text-md md:text-lg lg:text-xl xl:text-2xl 2xl:text-3xl font-medium bg-transform transition-transform duration-200 hover:scale-105 ${rtlTextClass}`}
            >
            ...
            <img
              ...
              alt="Arrow"
              className="w-12 md:w-16 lg:w-20 xl:w-24 2xl:w-28 h-auto object-contain bg-transform transition-transform duration-200 hover:scale-110"
